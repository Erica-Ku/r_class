...
hist(iris$Sepal.Length, xlab = "iris$Sepal.Length", col = "bisque", 
...
# 단계 2: lwd 속성 추가 사용
par(mfrow=c(1,1))
plot(price, type = "o", pch = 20, col = "green", cex = 2.0, lwd = 2)
